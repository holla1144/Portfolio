...
//var unique = _.map(data, 'skills');


var skills = _.uniq(_.flattenDeep(_.map(data, 'skills')));
...
var usersByFriends = _.map(_.orderBy(data, ['friends'], ['asc']), 'name');

console.log(usersByFriends);


var friendNames= _.uniq(_.map(_.flattenDeep(_.map(data, 'friends')), 'name'));
